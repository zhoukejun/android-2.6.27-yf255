/*------------------------------------------------------------------------
 ...
 . 03/10/2009 Updated to 2.6.x kernel from smc91111.h by zkj.
 .
 ---------------------------------------------------------------------------*/
...
struct smc_local {
	...
	unsigned int base;//zkj

	/* version/revision of the LAN91C113 chip */
	int	version;

	struct smc_platdata cfg;
...
#define SMC_inw(r)       *((volatile word *)((r)+ioaddr)) 
...
#define SMC_outw(d,r)   (*((volatile word *)((r)+ioaddr)) = (d))
#define SMC_outl(d,r)   (*((volatile dword *)((r)+ioaddr)) = (d))
